defmodule Issues.TableFormatter do
  ...
  @doc """
  Takes a list of row data, where each row is a Map, and a lsit of headers.
  ...
  @doc """
  Return a format string that hard-codes the widths of a set of columns. We
  ...
  selectors, and a format string, write the extracted data under control of
  the format string.
  """
  ...
  defp puts_one_line_in_columns(fields, format), do: :io.format(format, fields)
end
